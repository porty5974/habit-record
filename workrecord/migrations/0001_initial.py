# Generated by Django 3.0.2 on 2021-04-08 09:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='impressions', to='workrecord.Book', verbose_name='書籍')),
            ],
        ),
    ]
