...
urlpatterns = [
    ...
    path('book/mod/<int:pk>/', views.book_edit, name='book_mod'),  # 修正
    path('book/del/<int:pk>/', views.book_del, name='book_del'),   # 削除
    path('achieve/<int:pk>/', views.achieve, name='achieve'), #タスク完了
